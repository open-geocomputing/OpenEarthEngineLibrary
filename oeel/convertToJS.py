...
class exportEEjs():
	generatedFile='function readInputs(e,r){var n={};if(1==e.length&&"object"==typeof e[0]&&(r.filter(function(r){return -1!=Object.keys(e[0]).indexOf(r)}).length>0||0===Object.keys(e[0]).length))n=e[0];else for(var t=0;t<e.length;t++)n[r[t]]=e[t];var i=r.filter(function(e){return -1==Object.keys(n).indexOf(e)});if(i.length>0)throw"the following inpus are missing: "+i.map(function(e){return\'"\'+e+\'"\'}).join(", ");return n}function applyInputs(e,r){var n=JSON.parse(r),t=Object.keys(e);for(var i in t){var a=JSON.parse(ee.Serializer.toCloudApiJSON(e[t[i]]).replace(RegExp(\'"valueReference":"\',"g"),\'"valueReference":"\'+t[i])),l=Object.keys(a.values);for(var u in l)n.values[t[i]+l[u]]=a.values[l[u]]}return ee.Deserializer.decode(n)}';
	withSource=True
